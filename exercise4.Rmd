...
## Groundwater flow concepts {#E3B_3 .unnumbered}
...
### Creating a flow net  {.unnumbered}
...
### Interpreting a flow net {.unnumbered}
...
### Transmissivity {.unnumbered}

The transmissivity of an aquifer is the **depth-integrated hydraulic conductivity**, computed as:
...
5.  Using the diagram below, find the Transmissivity, T,  of the system.
 
 <center>

```{r E3Bimage2aa, echo=FALSE, fig.cap="Annotated cross section of an aquifer", out.width = '60%'}
knitr::include_graphics("images/exercise4/transmissivity.png")
```
</center>
...
6.  Based on this information, use Darcy’s Law to determine the transmissivity of the aquifer, in m2/s. 

Start by drawing your own diagram and annotate with the information that you know.
