# Exercise 11 - Assessing environmental flow impacts {#E10 -}
...
<center>=
```{r E10image1, echo=FALSE, fig.cap="Focus study sites where environmental water delivery is assessed in the MDB. Visit: https://flow-mer.org.au", out.width='100%'}
...
```{r E10image2, echo=FALSE, fig.cap="Example table to audit the variety of benefits reported across the different sites. Get the word template by clicking the download button in the tool bar.", out.width='100%'}
...
In this exercise, we have explored the complexities of allocating water to the environment in a contested situation (i.e., where there are competing "customers" for the water resource).  In particular, in the context of  **environmental flows** we can sumamrise :

-   rivers and associated habitats have intrinsic values
-   appreciate that there is a potential conflict between e-flow vs irrigation allocation
-   water manaagement activity can create stressors on dependent ecosystems
-   e-flow allocation is a river restoration and maintenance tool, to reduce stressors
