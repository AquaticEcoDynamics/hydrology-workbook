...
The experimental data saved from the data-logger can be used to visualise the change in rainfall and runoff (discharge) over time, and to calculate the total rainfall and runoff amount.
