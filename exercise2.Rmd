...
Whislt this exercise is focused around using the raw data from BOM, other useful resoruces for accessing rainfall data include [SILO](https://www.longpaddock.qld.gov.au/silo/), and [openmeteo](https://open-meteo.com/en/docs/historical-weather-api)
```
